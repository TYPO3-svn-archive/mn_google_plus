...
/**
 * Test case for class Tx_Mn_google_plus_Controller_GooglePlusController.
 *
 * @version $Id$
 ...
 */
class Tx_Mn_google_plus_Controller_GooglePlusControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
